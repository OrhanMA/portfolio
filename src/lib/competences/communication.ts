...
This skill directly protects software quality. An ambiguous need produces behavior that is difficult to validate; a hidden constraint reappears late; a poorly explained delivery remains unused. In my projects, I communicate with accounting, logistics, sales, designers, researchers, managers, and other developers. My role is to choose the right level of detail, make limitations visible, and never present an assumption or prototype as a fully validated outcome.`,
  ...
  selfCritique: {
    ...
    importance: {
      fr: "Elle est centrale parce que mon travail se situe à l'interface entre processus métier et logiciels. Une grande partie de ma valeur vient de la traduction : rendre une contrainte Odoo compréhensible, rendre une règle comptable applicable ou donner à la direction les éléments nécessaires pour arbitrer une limite technique.",
      en: "It is central because my work sits at the interface between business processes and software. Much of my value comes from translation: making an Odoo constraint understandable, an accounting rule implementable, or giving management enough information to decide how to address a technical limitation.",
    },
    acquisitionSpeed: {
