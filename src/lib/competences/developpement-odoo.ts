  ...
  anecdotes: [
    {
      ...
      result: {
        ...
        en: "Odoo 19 was deployed with no reported permanent data loss. Useful functions were retained, obsolete Studio customizations were removed, and the main integrations were modernized; downtime was not measured in a publishable way.",
      },
