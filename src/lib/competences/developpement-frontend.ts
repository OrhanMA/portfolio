  ...
  anecdotes: [
    {
      ...
      result: {
        fr: "La page d'accueil et le contact sont déjà présentables sur plusieurs navigateurs et formats, avec un système de composants réutilisable. Le principal défaut mobile de l'ancien site a été traité dès le développement plutôt qu'après la mise en ligne.",
    ...
    },
    {
      ...
      content: {
        ...
        en: `In CAP2vie, I was mainly responsible for the D3.js life-trajectory visualization. Questionnaire answers had to become exact or estimated periods distributed across five dimensions and readable through two modes. The chart also had to allow corrections that flowed back into the form. I worked with Vue and Nuxt, used D3.js primitives rather than a ready-made component, and evolved the display through three main versions to progressively align the representation with the researchers' method.`,
      },
      result: {
    ...
    },
    {
      ...
      content: {
        ...
        en: `The portfolio combines Next.js 16, React 19, Tailwind CSS, shadcn/ui, MDX, and GSAP. I built bilingual routes, server and client dictionaries, navigation, theme, transitions, Lenis scrolling, the blog, forms, and long-form editorial pages. The homepage is statically rendered without a client-side React runtime for its main content, while interactions remain isolated. Achievement and skill pages use contents navigation, limited reading widths, and genuine heading levels so their volume does not become a wall of text.`,
      },
      result: {
        fr: "Le site est publié, responsive et couvert par des tests unitaires, navigateur, visuels et bout en bout. Une mesure Lighthouse de juillet 2026 indique 95 en performance, 96 en accessibilité et 100 pour les bonnes pratiques et le SEO, valeurs que je conserve comme photographie datée plutôt que comme garantie permanente.",
        en: "The site is published, responsive, and covered by unit, browser, visual, and end-to-end tests. A July 2026 Lighthouse measurement reports 95 performance, 96 accessibility, and 100 for best practices and SEO, values I retain as a dated snapshot rather than a permanent guarantee.",
      },
