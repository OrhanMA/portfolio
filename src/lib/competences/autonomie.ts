  ...
  anecdotes: [
    ...
    },
    {
      ...
      result: {
        ...
        en: "Invoices are now checked automatically every day, while accounting directly controls the main settings. The time saving has not yet been measured; automation does not remove business users' responsibility for the underlying rules.",
      },
